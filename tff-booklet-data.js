...
(function (global) {
  var CHAPTERS = [
    ...
    },
    {
      ...
      subtitle: "Phones · tasting flight · admin results · QRs",
      accent: "#008fd3"
    }
  ];
  ...
  var ITEMS = [
    ...
    { n: 11, ch: 4, title: "Flavor portfolio gallery · live", type: "site", href: "/portfolio", desc: "53 flavors — on-shelf SKUs, presented concepts, pipeline flavors, Gen Alpha." },
    ...
    { n: 31, ch: 7, title: "Flavor Flight Challenge · /taste", type: "site", href: "/taste", desc: "Guest-friendly guided blind tasting for Sample A through Sample E." },
    { n: 32, ch: 7, title: "Flavor Flight results admin · /score", type: "site", href: "/score", desc: "Password-protected dashboard with averages, rankings, descriptors, daily-use intent, CSV export, and flavor key reveal." },
    { n: 33, ch: 7, title: "Tasting station signs", type: "site", href: "/stations", desc: "Print signs for the 10:30 tasting block with the Flavor Flight QR." },
    { n: 34, ch: 7, title: "Sample kit labels · A–E", type: "site", href: "/labels", desc: "Blind labels for Sample A through Sample E before the tasting block." },
    { n: 35, ch: 7, title: "QR print sheet · all scan codes", type: "site", href: "/qr", desc: "Postcards for visit guide, booklet, Flavor Flight, and team-only admin tools." }
  ];
  ...
  var AGENDA = [
    ...
    { time: "10:30–11:15", label: "Flavor Flight Challenge", note: "Samples A–E · guests use /taste · team reviews /score results" },
