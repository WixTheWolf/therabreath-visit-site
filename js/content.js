...
window.BOI = {
  ...
  showcase: {
    feature: {
      href: "/lakewood",
      accent: "#5fb832",
      tag: "Sensory validation",
      title: "Lakewood Site Parity Program",
      desc: "Eight-variant validation ladder — triangle, blind paired, and consumer escalation so Ross and R&D get a robust answer on whether taste differs across sites, and how.",
      stat: "8 variants · phased through Sep 2026",
    },
    items: [
      {
        href: "/portfolio",
      ...
      },
      {
        ...
        accent: "#5fb832",
        tag: "Brand",
        title: "TheraBreath brand hub",
        desc: "Categories, claims, and bottle lineup curated from therabreath.com — fast reference in the room.",
      },
      {
        href: "/booklet",
        accent: "#006da3",
      ...
      },
      {
        ...
        desc: "Single-page procurement summary — four pillars, agenda, and Lakewood path.",
      },
      {
        href: "/companies",
        accent: "#008fd3",
        tag: "Partners",
        title: "TFF × TheraBreath",
        desc: "Side-by-side company profiles — Norco capabilities, certifications, and brand story.",
      },
      {
        href: "/triangle",
        accent: "#f58220",
        tag: "Sensory",
        title: "Triangle test kit",
        desc: "ISO 4120 protocol and print forms — ready for Lakewood parity and NPD pilots.",
      },
    ],
  },
};